...
# Then the integration code. The same image serves the two roles:
#   - main container:            CMD ["node", "index.js"]   (glue SDK)
#   - "receiver" sub-container:  command ["node", "receiver.js"] (HTTP server)
COPY index.js receiver.js ./
COPY src ./src
